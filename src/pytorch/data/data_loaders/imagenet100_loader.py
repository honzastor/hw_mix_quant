...
IMAGENET100_DATA_DIR = os.path.join(DIR_PATH, '../datasets/imagenet100')


class Imagenet100Loader():
    def __init__(self, dataset_path: str = IMAGENET100_DATA_DIR):
        """
        Initialize the ImageNet100 data loader.

        Args:
            dataset_path (str): Path to the ImageNet100 dataset.
        """
